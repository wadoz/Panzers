...
public class Player extends Entity {
    ...
    public Player( float x, float y, float scale, TextureAtlas atlas, float speed) {
        super(EntipyType.Player, x, y);
        ...
        for (Heading h : Heading.values()) {
            SpriteSheet spriteSheet = new SpriteSheet(h.texture(atlas), SPRITES_PER_HEADING, SPRITE_SCALE );
